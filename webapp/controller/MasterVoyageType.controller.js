...
sap.ui.define(
    ...
    function (BaseController, ODataModel, Context, MessageBox, ODataContextBinding, MessageToast,History) {
        ...
        return BaseController.extend("nauticalfe.controller.MasterVoyageType", {
            ...
            onInit: function () {
                // this.getView().byId("mainPageSave").setAttribute("disabled", false);
                // this.getView().byId("newEntryPageSave").setAttribute("disabled", true); 
            },
            // back button 
            ...
            createData: function () {
                console.log("v2 create fn called");
            ...
            // },
            newEntries: function (oEvent) {
               this.getView().byId("createTypeTable").setVisible(false)
               this.getView().byId("entryTypeTable").setVisible(true)
               this.getView().byId("mainPageSave").setAttribute("disabled", true);
               this.getView().byId("newEntryPageSave").setAttribute("disabled", false)
            },
            saveNewEntries:function(){
                    /*write logic for saving the new entries..below is code for displaying main table
                    after creating a new record and saving it*/ 
            ...
            updateEntries:function(){
                    /*write logic for saving edited data in main page*/
                    this.getView().byId("mainPageSave").setAttribute("disabled", false);
                    this.getView().byId("newEntryPageSave").setAttribute("disabled", true);              
                    alert('main page save') 
            },
